...
describe('Artist Search Error Handing', () => {
  ...
  it('Should let the user know if there is an internal code error regarding fetch request when searching for artists', () => {
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.search&artist=Smash%20Mouth&api_key=fcf48a134034bb684aa87d0e0309a0fd%20%20%20%20&limit=15&format=json`, {
      statusCode: 400
    })
  ...
  it('Should let the user know if a band they type cannot be processed by the API', () => {
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.search&artist=Bad%20Name&api_key=fcf48a134034bb684aa87d0e0309a0fd%20%20%20%20&limit=15&format=json`, {
      method: 'GET',
...
describe(`Artist's Album Search Error Handling`, () => {
  ...
  it(`Should let the user know if there is an internal code error regarding fetch request when getting that artist's top albums`, () => {
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist=Smash%20Mouth&api_key=fcf48a134034bb684aa87d0e0309a0fd&limit=30&format=json`, {
      statusCode: 400
    })
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.search&artist=Smash%20Mouth&api_key=fcf48a134034bb684aa87d0e0309a0fd%20%20%20%20&limit=15&format=json`, {
      method: 'GET',
  ...
  it('Should let the user know if the API sends back an ok reponse, but has an error message', () => {
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.search&artist=Bad%20Artist&api_key=fcf48a134034bb684aa87d0e0309a0fd%20%20%20%20&limit=15&format=json`, {
      method: 'GET',
      fixture: '../fixtures/badArtist.json'
    })
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist=Bad%20Artist&api_key=fcf48a134034bb684aa87d0e0309a0fd&limit=30&format=json`, {
      method: 'GET',
  ...
  it('Should let the user know the data for the artist they clicked on does not have any albums in it', () => {
    ...
    cy.intercept(`https://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&artist=Bad%20Artist%20Collab&api_key=fcf48a134034bb684aa87d0e0309a0fd&limit=30&format=json`, {
      method: 'GET',
